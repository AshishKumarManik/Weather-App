...
def home(request):
    ...
    url = f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=c11670846ef59d0ae132366e89e57b1d'

    # Parameters to request temperature in metric units (Celsius)
    PARAMS = {'units': 'metric'}

    # Your Google Custom Search API Key (keep it secret)
    API_KEY = 'AIzaSyB8qG43-ag7vLXS2S25WbI4CPdD5JZpTrA'

    # Your Google Custom Search Engine ID
    SEARCH_ENGINE_ID = '05af2df91f18d448b'  
